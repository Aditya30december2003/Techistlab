        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-20 p-5 text-white mt-20">
          <div className="cursor-pointer rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:shadow-[5px_5px_0px_0px_rgba(109,40,217)] hover:rounded-md duration-700">
            <div className="absolute h-[20rem]">
              <h1 className="text-xl text-center font-bold mt-20 p-10 mx-auto bg-purple-300 w-[80%] rounded-md">The Future of Mobile Commerce: Trends to Watch in 2024</h1>
            </div>
          ...
          <div className="cursor-pointer rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:shadow-[5px_5px_0px_0px_rgba(109,40,217)] hover:rounded-md duration-700">
            <div className="absolute">
              <h1 className="text-xl text-center font-bold mt-20 p-10 mx-auto bg-purple-300 w-[80%] rounded-md">User-Centric Design: Why It Matters More Than Ever</h1>
            </div>
