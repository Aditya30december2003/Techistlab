...
const Home = () => {
  return (
    <div className="px-4 pt-[10rem]">
      ...
      <div className="bg-gradient-to-r font-bold text-[1rem] lg:text-[1.3rem] mt-4 text-center w-[100%] lg:w-[70%] mx-auto">We craft custom web and mobile applications that help you connect with your audience, streamline operations, and scale with confidence.</div>
      
      <div className="mx-auto text-center w-[95%] text-white lg:w-[45%] mt-6 flex items-center border p-2 rounded-[5rem]">
