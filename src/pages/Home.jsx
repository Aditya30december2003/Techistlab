...
repeat= {Infinity}/>
      ...
      <div className="mx-auto text-center font-bold text-[1.2rem] rounded-md lg:text-[1.2rem] bg-purple-200 p-2 text-gray-700/80">
      ...
      <div className="mt-7 px-7 py-2">
        ...
        <div className="grid mt-7 gap-16">
          ...
          <div className="border-2 cursor-pointer p-6 flex flex-col gap-2 rounded-md shadow-[10px_10px_1px_1px_#D6B4FC]  lg:hover:shadow-[10px_10px_1px_1px_#D6B4FC] hover:scale-105">
                <p><FaReact size={70}/></p>
