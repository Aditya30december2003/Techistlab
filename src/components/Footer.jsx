...
const Footer = () => {
  ...
  <div className="bg-gray-400 rounded-full w-[21rem] h-[21rem] lg:w-[24rem] lg:h-[24rem] flex-col text-center justify-center items-center">
    <img 
      src="https://techistlab.co.uk/assets/logo-D8JJhk6e.png" 
      alt="Logo" 
      className="w-48 h-48 object-contain mx-auto"
    />
    <div className='font-bold text-[1rem] lg:text-[1.4rem]'>
  ...
  +44(0)20 3723 6703
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link to="/about"  className="text-[1.25rem] font-light">About</Link>
          <Link to="/blog"  className="text-[1.25rem] font-light">Blog</Link>
          <Link to="/careers"  className="text-[1.25rem] font-light">Careers</Link>
          <Link to="/contact"  className="text-[1.25rem] font-light">Contact</Link>
          <Link to="/portfolio"  className="text-[1.25rem] font-light">Portfolio</Link>
          <Link to='services' className="text-[1.25rem] font-light">Services</Link>
          <Link to='teams' className="text-[1.25rem] font-light">Teams</Link>
        </div>
