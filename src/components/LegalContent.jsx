              ...
              {navItems.map((item) => (
                <li key={item.id} className="relative duration-100">
                  ...
                  <button
                    ...
                    className={`text-[0.95rem] font-medium duration-200 text-left w-full hover:text-purple-600 ${
          ...
          {contentSections.map((section) => (
            <section key={section.id} id={section.id} className="mb-16">
              ...
              {expandedSections[section.id] && (
                <div className="mt-4 text-[0.95rem] lg:text-lg leading-relaxed prose prose-purple max-w-none">
                  {section.content}
                </div>
              )}
            </section>
